...
3. **Output** lands beside the script; set `PRESS_OUT=<Type>_<Subject>_<YYYY-MM-DD>.docx` to name it — a file name only, any directory part is stripped so the deliverable stays in the document home. Filename ASCII, underscores.
